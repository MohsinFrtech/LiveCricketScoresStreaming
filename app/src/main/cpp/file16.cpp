...
Java_com_traumsportzone_live_cricket_tv_scores_streaming_ui_activities_HomeScreen_getStringArray16(JNIEnv *env,
                                                                                   jobject thiz) {
...
extern "C"
JNIEXPORT jobjectArray JNICALL
Java_com_traumsportzone_live_cricket_tv_scores_tv_activities_TvMainActivity_getStringArray16(JNIEnv *env,
                                                                              jobject thiz) {
    jobjectArray strarr = env->NewObjectArray(10, env->FindClass("java/lang/String"), nullptr);
    std::string LiJ = "Z!l5b&&&ZYE!eWVH2un6!pGRce@7uD3lvFTgkove";
    env->SetObjectArrayElement(strarr, 0, env->NewStringUTF(LiJ.c_str()));
